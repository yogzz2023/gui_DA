...
tk.Label(main_frame, text="Measurement 1 (x, y):", font=('Helvetica', 12), bg='white', fg='black').grid(row=8, column=0, sticky="w", pady=5)
tk.Label(main_frame, text="x:", font=('Helvetica', 10), bg='white', fg='black').grid(row=9, column=0, sticky="w")
tk.Label(main_frame, text="y:", font=('Helvetica', 10), bg='white', fg='black').grid(row=10, column=0, sticky="w")

tk.Label(main_frame, text="Measurement 2 (x, y):", font=('Helvetica', 12), bg='white', fg='black').grid(row=11, column=0, sticky="w", pady=5)
tk.Label(main_frame, text="x:", font=('Helvetica', 10), bg='white', fg='black').grid(row=12, column=0, sticky="w")
tk.Label(main_frame, text="y:", font=('Helvetica', 10), bg='white', fg='black').grid(row=13, column=0, sticky="w")
...
entry_m1_x = tk.Entry(main_frame, font=('Helvetica', 10), bg='gray90')
entry_m1_x.grid(row=9, column=1)
entry_m1_y = tk.Entry(main_frame, font=('Helvetica', 10), bg='gray90')
entry_m1_y.grid(row=10, column=1)

entry_m2_x = tk.Entry(main_frame, font=('Helvetica', 10), bg='gray90')
entry_m2_x.grid(row=12, column=1)
entry_m2_y = tk.Entry(main_frame, font=('Helvetica', 10), bg='gray90')
entry_m2_y.grid(row=13, column=1)

# Buttons with improved appearance and layout
button_frame = tk.Frame(main_frame, bg='white')
button_frame.grid(row=14, columnspan=2, pady=10)
...
association_button = tk.Button(button_frame, text="Calculate Association Probability", font=('Helvetica', 12), bg='blue', fg='white', command=calculate_association_probability)
association_button.pack(side=tk.LEFT, padx=10)

update_button = tk.Button(button_frame, text="Calculate Updated Position", font=('Helvetica', 12), bg='orange', fg='white', command=calculate_updated_position)
