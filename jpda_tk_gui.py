...
# Labels
# Add labels for target positions and probability values
...
calc_pred_button = tk.Button(main_frame, text="Calculate Predicted Position", font=('Helvetica', 12), bg='blue', fg='white', command=calculate_predicted_position)
calc_pred_button.grid(row=14, columnspan=2, pady=10)

calc_assoc_prob_button = tk.Button(main_frame, text="Calculate Association Probability", font=('Helvetica', 12), bg='blue', fg='white', command=calculate_association_probability)
calc_assoc_prob_button.grid(row=15, columnspan=2, pady=10)

calc_upd_pos_button = tk.Button(main_frame, text="Calculate Updated Position", font=('Helvetica', 12), bg='blue', fg='white', command=calculate_updated_position)
calc_upd_pos_button.grid(row=16, columnspan=2, pady=10)
