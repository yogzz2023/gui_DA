...
# Labels
tk.Label(main_frame, text="Target 1 (initial):", font=('Helvetica', 12), bg='black', fg='white').grid(row=0, column=0, sticky="w", pady=5)
...
tk.Label(main_frame, text="Target 2 (initial):", font=('Helvetica', 12), bg='black', fg='white').grid(row=3, column=0, sticky="w", pady=5)
